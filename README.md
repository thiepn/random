...
**Stable release: v1.2.0** — production-certified on 2026-09-26. See [CHANGELOG.md](./CHANGELOG.md), [RELEASE-NOTES-v1.2.0.md](./RELEASE-NOTES-v1.2.0.md), [PRODUCTION-CERTIFICATION.md](./PRODUCTION-CERTIFICATION.md), and [MAINTENANCE.md](./MAINTENANCE.md).

v1.0.0 remains the architectural production baseline. v1.2.0 completes the backward-compatible **Tactile Chance Arcade** redesign; follow-up work returns to targeted maintenance and patch releases unless another minor release is deliberately scoped.

## v1.2 experience redesign — released

**v1.2.0** completes the R1–R8 visual/experience overhaul while preserving the product's randomization, persistence, privacy, portability, and offline contracts.
...
**R8 release certification:** R1–R7 are source-audited together, remaining ordinary dark-only legacy surfaces are migrated to materials, and the live Chromium matrix is verified: 39 rendered checkpoints, 25/25 built-in tool runs, responsive Night/Day states, accessibility modes, touch/keyboard, long-label Wheel and all accent states. The evidence-recording head passed CI and Pages before v1.2.0 publication.
